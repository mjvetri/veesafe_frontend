...
//   // ✅ SOFT LIGHT TEAL — romba light, calm, professional
//   static const Color green     = Color(0xFF3DBCB8);   // Soft Teal (not too bright)
//   static const Color greenDark = Color(0xFF2E9E9A);   // Slightly deeper Teal
...
//   static const Color iconGreen  = Color(0xFFE0F7F4);   // very light mint bg
