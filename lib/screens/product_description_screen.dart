...
//   final raw = _price.replaceAll(RegExp(r'[^\d.]'), '');
//   return double.tryParse(raw) ?? 2604.0;
// }

// double get _rentalPrice {
//   switch (_rentalDuration) {
//     case RentalDuration.daily:   return _parsedPrice * 0.05 * _rentalCount;
//     case RentalDuration.weekly:  return _parsedPrice * 0.25 * _rentalCount;
//     case RentalDuration.monthly: return _parsedPrice * 0.60 * _rentalCount;
//   }
// }
...
//         decoration: BoxDecoration(
//           color: _orderMode == OrderMode.buy ? kNavy : Colors.transparent,
//           borderRadius: BorderRadius.circular(10),
//         ),
//         child: Center(child: Text('🛒  Buy',
//             style: TextStyle(
//                 color: _orderMode == OrderMode.buy ? Colors.white : kTextGrey,
//                 fontWeight: FontWeight.w700, fontSize: sw * 0.034))),
//       ),
//     )),
//     Expanded(child: GestureDetector(
...
//         padding: EdgeInsets.symmetric(vertical: sw * 0.025),
//         decoration: BoxDecoration(
//           color: _orderMode == OrderMode.rent ? kTeal : Colors.transparent,
//           borderRadius: BorderRadius.circular(10),
//         ),
//         child: Center(child: Text('📅  Rent',
//             style: TextStyle(
//                 color: _orderMode == OrderMode.rent ? Colors.white : kTextGrey,
//                 fontWeight: FontWeight.w700, fontSize: sw * 0.034))),
//       ),
//     )),
//   ]),
...
// //           style: TextStyle(fontSize: sw * 0.032, fontWeight: FontWeight.w700, color: kTeal)),
// //       SizedBox(height: sw * 0.02),
...
// //             decoration: BoxDecoration(
// //               color: sel ? kTeal : Colors.white,
// //               borderRadius: BorderRadius.circular(8),
// //               border: Border.all(color: sel ? kTeal : Colors.grey.shade300),
// //             ),
// //             child: Center(child: Text(labels[d]!,
...
// //       }).toList()),
// //       SizedBox(height: sw * 0.015),
// //       Text('* Security deposit (refundable) will be collected at checkout',
// //           style: TextStyle(fontSize: sw * 0.026, color: kTextGrey, fontStyle: FontStyle.italic)),
// //     ]),
// //   ),
// // ],
...
//         };
//         final prices = {
//           RentalDuration.daily:   '\$${(_parsedPrice * 0.05).toStringAsFixed(0)}/day',
//           RentalDuration.weekly:  '\$${(_parsedPrice * 0.25).toStringAsFixed(0)}/wk',
//           RentalDuration.monthly: '\$${(_parsedPrice * 0.60).toStringAsFixed(0)}/mo',
//         };
//         final sel = _rentalDuration == d;
//         return Expanded(child: GestureDetector(
//           onTap: () => setState(() => _rentalDuration = d),
...
//               borderRadius: BorderRadius.circular(10),
//               border: Border.all(color: sel ? kTeal : Colors.grey.shade300),
//               boxShadow: sel ? [BoxShadow(color: kTeal.withOpacity(0.3), blurRadius: 6, offset: const Offset(0, 2))] : [],
//             ),
//             child: Column(children: [
//               Text(labels[d]!, style: TextStyle(
//                   fontSize: sw * 0.028, fontWeight: FontWeight.w700,
//                   color: sel ? Colors.white : kTextDark)),
//               SizedBox(height: sw * 0.005),
//               Text(prices[d]!, style: TextStyle(
//                   fontSize: sw * 0.022,
//                   color: sel ? Colors.white70 : kTextGrey)),
//             ]),
//           ),
//         ));
//       }).toList()),
...
//         child: Row(children: [
//           Text('Duration Count',
//               style: TextStyle(fontSize: sw * 0.03, color: kTextDark, fontWeight: FontWeight.w600)),
//           const Spacer(),
//           GestureDetector(
//             onTap: () { if (_rentalCount > 1) setState(() => _rentalCount--); },
//             child: Container(
//               width: sw * 0.08, height: sw * 0.08,
//               decoration: BoxDecoration(color: kNavy.withOpacity(0.08), borderRadius: BorderRadius.circular(8)),
//               child: Icon(Icons.remove, size: sw * 0.04, color: kNavy),
//             ),
//           ),
//           Padding(
//             padding: EdgeInsets.symmetric(horizontal: sw * 0.04),
//             child: Text('$_rentalCount',
//                 style: TextStyle(fontSize: sw * 0.036, fontWeight: FontWeight.w800, color: kNavy)),
//           ),
//           GestureDetector(
...
//               width: sw * 0.08, height: sw * 0.08,
//               decoration: BoxDecoration(color: kNavy.withOpacity(0.08), borderRadius: BorderRadius.circular(8)),
//               child: Icon(Icons.add, size: sw * 0.04, color: kNavy),
//             ),
//           ),
//         ]),
//       ),
...
//             Text('Rental Price',
//                 style: TextStyle(fontSize: sw * 0.029, color: kTextGrey)),
//             Text('\$${_rentalPrice.toStringAsFixed(2)}',
//                 style: TextStyle(fontSize: sw * 0.034, fontWeight: FontWeight.w800, color: kNavy)),
//           ]),
//           SizedBox(height: sw * 0.012),
//           Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
//             Text('Security Deposit',
//                 style: TextStyle(fontSize: sw * 0.029, color: kTextGrey)),
//             Text('\$${(_parsedPrice * 0.20).toStringAsFixed(0)} (refundable)',
//                 style: TextStyle(fontSize: sw * 0.029, fontWeight: FontWeight.w600, color: const Color(0xFF2E7D32))),
//           ]),
//         ]),
//       ),

//       SizedBox(height: sw * 0.012),
//       Text('* Deposit refunded after product return in good condition',
//           style: TextStyle(fontSize: sw * 0.024, color: kTextGrey, fontStyle: FontStyle.italic)),
//     ]),
//   ),
// ],
...
//     _orderMode == OrderMode.rent ? 'Add to Rent' : 'Add to Cart',
//     kNavy, sw,
//     icon: _orderMode == OrderMode.rent ? Icons.calendar_month : Icons.shopping_cart_outlined,
//     onTap: _addToCart)),
//   SizedBox(width: sw * 0.025),
//   Expanded(child: _actionBtn(
//     _orderMode == OrderMode.rent ? 'Rent Now' : 'Buy Now',
//     kTeal, sw,
//     icon: _orderMode == OrderMode.rent ? Icons.event_available : Icons.flash_on_rounded,
//     onTap: () {
//       Navigator.push(context, MaterialPageRoute(builder: (_) => const CheckoutPaymentScreen()));
//     })),
// ]),
...
import 'cart_screen.dart';
import '../models/rental_model.dart';
import 'healthcare/widgets/healthcare_assistance_widget.dart';
...
class _ProductDescriptionScreenState extends State<ProductDescriptionScreen>
  ...
  double get _rentalPrice {
    switch (_rentalDuration) {
      case RentalDuration.daily:
        return _parsedPrice * 0.05 * _rentalCount;
      case RentalDuration.weekly:
        return _parsedPrice * 0.25 * _rentalCount;
      case RentalDuration.monthly:
        return _parsedPrice * 0.60 * _rentalCount;
    }
  }
  ...
  final List<Map<String, dynamic>> _offers = [
    {
      'code': 'HEALTH10',
      'desc': '10% off on orders above \$1,000',
      'icon': Icons.local_offer_outlined,
      'badge': '10% OFF',
    },
    {
      'code': 'SAVE5',
      'desc': '5% cashback on first order',
  ...
  final List<Map<String, dynamic>> _reviewsList = [
    {
      ...
      'date': '12 Jan 2025',
      'comment':
          'We can get you with your medical needs. Our team of experts is here to make sure you get the best quality products.',
      'helpful': 24,
    },
    {
      'name': 'Rekha',
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => CheckoutPaymentScreen(
          isRental: _orderMode == OrderMode.rent,
          rentalDuration: _rentalDuration.name,
          rentalCount: _rentalCount,
          rentalPrice: _rentalPrice,
          securityDeposit: _parsedPrice * 0.20,
          productTitle: _productTitle,
          productPrice: _orderMode == OrderMode.rent
    ...
    return Stack(
      children: [
                    ...
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: sel ? kTeal : kNavy.withOpacity(0.2),
                            width: sel ? 2.5 : 1,
                          ),
                          boxShadow: sel
                              ? [
        ...
        Positioned(
          top: sw * 0.03,
          left: sw * 0.04,
          child: _chip(widget.tag ?? 'On Sale', kRed),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  _orderMode == OrderMode.rent ? 'RENTAL' : _discount,
                  style: TextStyle(
                    color: kRed,
                    fontSize: sw * 0.028,
                    fontWeight: FontWeight.w800,
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      padding: EdgeInsets.symmetric(vertical: sw * 0.028),
                      decoration: BoxDecoration(
                        color: _orderMode == OrderMode.buy
                            ? kNavy
                            : Colors.transparent,
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: _orderMode == OrderMode.buy
                            ? [
                                BoxShadow(
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      padding: EdgeInsets.symmetric(vertical: sw * 0.028),
                      decoration: BoxDecoration(
                        color: _orderMode == OrderMode.rent
                            ? kTeal
                            : Colors.transparent,
                        borderRadius: BorderRadius.circular(10),
                        boxShadow: _orderMode == OrderMode.rent
                            ? [
                                BoxShadow(
          ...
          // ══════════════════════════════════
          // RENTAL OPTIONS PANEL (shows when Rent is selected)
          // ══════════════════════════════════
          AnimatedCrossFade(
            duration: const Duration(milliseconds: 300),
            crossFadeState: _orderMode == OrderMode.rent
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Daily / Weekly / Monthly tabs
                      Row(
                        children: RentalDuration.values.map((d) {
                          final labels = {
                            RentalDuration.daily: 'Daily',
                            RentalDuration.weekly: 'Weekly',
                            RentalDuration.monthly: 'Monthly',
                          ...
                          final prices = {
                            RentalDuration.daily:
                                '\$${(_parsedPrice * 0.05).toStringAsFixed(0)}/day',
                            RentalDuration.weekly:
                                '\$${(_parsedPrice * 0.25).toStringAsFixed(0)}/wk',
                            RentalDuration.monthly:
                                '\$${(_parsedPrice * 0.60).toStringAsFixed(0)}/mo',
                          };
                          final sel = _rentalDuration == d;
                          return Expanded(
                            child: GestureDetector(
                              ...
                              child: AnimatedContainer(
                                ...
                                margin: EdgeInsets.only(
                                  right: d != RentalDuration.monthly
                                      ? sw * 0.02
                                      : 0,
                                ),
                                padding: EdgeInsets.symmetric(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(10),
                                  border: Border.all(
                                    color: sel ? kTeal : Colors.grey.shade300,
                                  ),
                                  boxShadow: sel
                                      ? [
                                          BoxShadow(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '\$${(_parsedPrice * 0.20).toStringAsFixed(0)} (refundable)',
                                  style: TextStyle(
                                    fontSize: sw * 0.029,
                                    fontWeight: FontWeight.w600,
                                    color: kGreen,
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Deposit fully refunded after product return in good condition',
                              style: TextStyle(
                                fontSize: sw * 0.026,
                                color: kTextGrey,
            ...
            children: [
              Expanded(
                child: _actionBtn(
                  ...
                  kNavy,
                  sw,
                  icon: _orderMode == OrderMode.rent
          ...
          SizedBox(height: sw * 0.025),
          HealthcareAssistanceWidget(productName: widget.productTitle),
  ...
  Widget _buildDescriptionTab(double sw) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: sw * 0.015),
        Text(
          'We are glad to help you with your medical needs. Our team of experts is here to make sure you get the best quality products and services at affordable prices.',
          style: TextStyle(
            fontSize: sw * 0.031,
            color: kTextGrey,
            height: 1.65,
          ...
          itemBuilder: (_, i) {
            ...
            return Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: kNavy.withOpacity(0.08)),
              ),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
    ...
    return Column(
      ...
      children: [
        ...
        _infoRow(
          ...
          'Delivery on January 31; use prime to get delivery within 24hours',
          sw,
        ),
        SizedBox(height: sw * 0.014),
        _infoRow(Icons.replay, '7 Days Replacement Policy', sw),
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                radius: sw * 0.045,
                backgroundColor: kNavy.withOpacity(0.12),
                child: Text(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xFFEBEFF8), Color(0xFFD4E4F7)],
                  ),
                ),
                child: Stack(
                  children: [
  ...
  Widget _infoRow(IconData icon, String text, double sw) => Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          text,
          style: TextStyle(fontSize: sw * 0.029, color: kTextDark, height: 1.4),
        ),
      ),
    ],
  );
    ...
    children: [
      Container(
        ...
        decoration: BoxDecoration(
          color: kLightBg,
          shape: BoxShape.circle,
          border: Border.all(color: kNavy.withOpacity(0.1)),
        ),
        child: Icon(icon, color: kNavy, size: sw * 0.065),
      ),
      SizedBox(height: sw * 0.012),
