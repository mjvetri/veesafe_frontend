                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 11,
                          color: hasReply ? AppColors.kGrey : const Color(0xFF16A34A),
                          fontWeight:
          ...
          child: Column(
            children: [
              Container(
                ...
                height: 70,
                decoration:
                    BoxDecoration(color: AppColors.kBlueLite, shape: BoxShape.circle),
                child: const Icon(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 13.5,
                              color: isMe ? Colors.white : AppColors.kBlack,
                              height: 1.4,
                            ),
                          ),
                          const SizedBox(height: 4),
                          Row(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 10,
                                  color: isMe ? Colors.white60 : AppColors.kGrey,
                                ),
                              ),
                              if (isMe) ...[
                                const SizedBox(width: 4),
