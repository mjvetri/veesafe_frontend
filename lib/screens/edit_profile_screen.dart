...
class _EditProfileScreenState extends State<EditProfileScreen>
    ...
    showModalBottomSheet(
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            Container(width: 40, height: 4,
                decoration: BoxDecoration(color: AppColors.kBorderGrey,
                    borderRadius: BorderRadius.circular(10))),
            const SizedBox(height: 20),
            const Text('Upload Profile Photo',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.kBlack)),
            const SizedBox(height: 24),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _photoOpt(Icons.camera_alt_rounded, 'Camera', AppColors.kBlue, () {
                  Navigator.pop(context);
                  setState(() => _hasPhoto = true);
                  _showSnack('Camera opened!', AppColors.kBlue);
                }),
                _photoOpt(Icons.photo_library_rounded, 'Gallery', const Color(0xFF7C3AED), () {
                  Navigator.pop(context);
                  setState(() => _hasPhoto = true);
                  _showSnack('Gallery opened!', AppColors.kBlue);
                }),
                _photoOpt(Icons.delete_outline_rounded, 'Remove', Colors.red, () {
                  Navigator.pop(context);
                  setState(() => _hasPhoto = false);
  ...
  void _verifyEmail() {
    ...
    showDialog(context: context,
      builder: (_) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        title: const Text('Verify Email',
            style: TextStyle(fontWeight: FontWeight.w800, color: AppColors.kBlack)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('Enter the OTP sent to\n${_emailCtrl.text}',
                textAlign: TextAlign.center,
                style: const TextStyle(fontSize: 13, color: AppColors.kGrey)),
            const SizedBox(height: 16),
            TextField(
              controller: otpCtrl,
              keyboardType: TextInputType.number,
              ...
              decoration: InputDecoration(
                counterText: '',
                hintText: '------',
                hintStyle: const TextStyle(color: AppColors.kBorderGrey),
        ...
        actions: [
          TextButton(onPressed: () => Navigator.pop(context),
              child: const Text('Cancel', style: TextStyle(color: AppColors.kGrey))),
          ElevatedButton(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    isDense: true,
                    suffixIcon: IconButton(
                      icon: Icon(showNew ? Icons.visibility_off : Icons.visibility, color: AppColors.kGrey),
                      onPressed: () => setBS(() => showNew = !showNew),
                    ),
                  ),
                ),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              if (ctrl.text.trim().isNotEmpty) {
                setState(() => _extraEducations.add(ctrl.text.trim()));
                Navigator.pop(context);
                _showSnack('Education added!', AppColors.kBlue);
              }
            },
            child: const Text('Add', style: TextStyle(color: Colors.white)),
          ),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              if (ctrl.text.trim().isNotEmpty) {
                setState(() => _extraWorkplaces.add(ctrl.text.trim()));
                Navigator.pop(context);
                _showSnack('Workplace added!', AppColors.kBlue);
              }
            },
            child: const Text('Add', style: TextStyle(color: Colors.white)),
          ),
  ...
  Widget _appBar(BuildContext context) => Container(
    decoration: const BoxDecoration(
      gradient: LinearGradient(colors: [AppColors.kBlue, Color(0xFF1A73E8)],
          begin: Alignment.centerLeft, end: Alignment.centerRight),
    ),
    padding: const EdgeInsets.fromLTRB(4, 6, 14, 10),
    child: Row(
                  ...
                  child: Stack(
                    children: [
                      Container(
                        ...
                        child: ClipOval(
                          child: _hasPhoto
                              ? Container(color: AppColors.kBlueLite,
                              child: const Icon(Icons.check_circle_rounded,
                                  size: 40, color: AppColors.kBlue))
                              : const Icon(Icons.person_rounded,
                                  size: 42, color: Color(0xFFB0BEC5)),
                        ),
                      ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: AppColors.kBlue.withOpacity(0.35), width: 1.5),
                boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.03),
                    blurRadius: 6, offset: const Offset(0, 2))],
              ),
              child: const Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.add_circle_outline_rounded, size: 18, color: AppColors.kBlue),
                  SizedBox(width: 6),
                  Text('Add Address',
                      style: TextStyle(
                          fontSize: 13,
                      ...
                      if ((a['line1'] ?? '').isNotEmpty)
                        Text(
                          [a['line1'], a['city'], a['pincode']]
                              ...
                              .join(', '),
                          style: const TextStyle(
                              fontSize: 12, color: AppColors.kBlack,
                              fontWeight: FontWeight.w600, height: 1.4),
                        ),
                      if ((a['street'] ?? '').isNotEmpty)
                        Text(
                          [a['street'], a['city2'], a['pincode2']]
                              ...
                              .join(', '),
                          style: const TextStyle(
                              fontSize: 12, color: AppColors.kGrey, height: 1.4),
                        ),
                    ],
                  ),
                ),
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: UnderlineInputBorder(
                  borderSide: BorderSide(color: AppColors.kBlue, width: 1.8),
                ),
              ),
            ),
          ],
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            ...
            GestureDetector(
              ...
              child: _badge('Change', AppColors.kBlue),
            ),
          ],
        ),
        const SizedBox(height: 6),
        TextFormField(
          ...
          obscureText: !_showPass,
          style: const TextStyle(
              fontSize: 13, fontWeight: FontWeight.w500, color: AppColors.kBlack),
          decoration: InputDecoration(
            hintText: 'Min 6 characters',
            hintStyle: const TextStyle(
                fontSize: 13, color: Color(0xFFBBC5D5), fontWeight: FontWeight.w400),
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            const Divider(color: AppColors.kBorderGrey, height: 1),
            ConstrainedBox(
              constraints: BoxConstraints(
                maxHeight: MediaQuery.of(context).size.height * 0.45,
              ),
              ...
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w500,
                      color: _selectedDOB != null ? AppColors.kBlack : const Color(0xFFBBC5D5)),
                ),
              ),
              const Icon(Icons.calendar_today_rounded, size: 18, color: AppColors.kGrey),
            ],
          ),
        ),
        const Divider(color: Color(0xFFE0E0E0), thickness: 1, height: 12),
  ...
  Widget _chip(String text, VoidCallback onDelete) => Padding(
    ...
    child: Container(
      padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
      decoration: BoxDecoration(color: AppColors.kBlueLite, borderRadius: BorderRadius.circular(12),
          border: Border.all(color: AppColors.kBlue.withOpacity(0.2))),
      child: Row(
        children: [
          const Icon(Icons.check_circle_rounded, color: AppColors.kBlue, size: 16),
          const SizedBox(width: 8),
          Expanded(child: Text(text,
              style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.kBlack))),
          GestureDetector(onTap: onDelete,
              child: const Icon(Icons.close_rounded, color: AppColors.kGrey, size: 16)),
        ],
      ),
    ),
  );
  ...
  Widget _addButton(String label, VoidCallback onTap) => GestureDetector(
    ...
    child: Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.add_circle_outline_rounded, size: 18, color: AppColors.kBlue),
          const SizedBox(width: 6),
          Text(label,
              style: const TextStyle(fontSize: 13, color: AppColors.kBlue, fontWeight: FontWeight.w700)),
        ],
      ),
    ),
  );
