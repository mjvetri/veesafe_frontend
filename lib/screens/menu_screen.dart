...
class MenuScreen extends StatelessWidget {
            ...
            actions: [
              TextButton(
                ...
                child: const Text('Cancel',
                    style: TextStyle(color: AppColors.kGrey, fontWeight: FontWeight.w600)),
              ),
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: AppColors.kBlue, foregroundColor: Colors.white,
                  shape: RoundedRectangleBorder(
  ...
  Widget _footer() => const Row(
    ...
    children: [
      Text('Made in india',
          style: TextStyle(fontSize: 12, color: AppColors.kGrey, fontWeight: FontWeight.w400)),
    ],
  );
  ...
  Widget _menuTile(
    ...
    String? badge,
      ...
      Material(
        ...
        child: InkWell(
          onTap: onTap,
          splashColor: AppColors.kBlueLite,
          highlightColor: AppColors.kBlueLite,
          child: Padding(
                ...
                children: [
                  ...
                  if (badge != null)
                    ...
                    const Icon(Icons.chevron_right,
                        size: 18, color: AppColors.kBorderGrey),
                ],
              ),
            ),
          ),
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                border: Border(
                    bottom: BorderSide(color: AppColors.kBorderGrey, width: 0.8)),
              ),
              child: Row(
                children: [
                  Expanded(
                  ...
                  const Icon(Icons.chevron_right, size: 18, color: AppColors.kBlue),
                ],
              ),
            ),
          ),
